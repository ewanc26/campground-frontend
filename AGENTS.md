...
Guidance for AI coding agents working in **campground-frontend**.
...
Sync AGENTS.md from zincfox; Sync CONTRIBUTING.md from zincfox; Sync AGENTS.md from zincfox; Sync CONTRIBUTING.md from zincfox; Update crowdin.yml